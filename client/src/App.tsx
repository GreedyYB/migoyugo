    ...
    <div className="App">
      ...
      {showRules && (
        <>
          ...
          <div className="notification rules-popup" style={{ display: 'block', position: 'fixed', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', width: '96vw', maxWidth: 500, maxHeight: '80vh', overflow: 'visible', zIndex: 1002 }}>
